  ...
  async loadBlockchainData(dispatch) {
    ...
    if (typeof window.ethereum !== "undefined") {
      ...
      try {
        ...
        console.log("error", e);
        window.alert("Contracts not deployed to the curren network");
      }
    } else {
                    ...
                    <div>
                      ...
                      <form
                        onSubmit={(e) => {
                          ...
                          amount = Web3.utils.toWei(amount.toString(), "ether"); //convert to wei
                          this.deposit(amount);
                        }}
                      >
                        <div className="form-group mr-sm-2">
                          ...
                          <input
                            ...
                            step="0.01"
                            type="number"
                            className="form-control form-montrol-md"
                            placeholder="amount..."
                            required
                            ref={(input) => {
